...
<div class="noticecontainer">
	...
	<div class="leftnotice">
		<form id="myNoticeForm" enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				<textarea class="form-control" rows="5" placeholder="content here"
					id="noticebody" name="noticebody"></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="input-group">
					<input type="text" class="form-control" id="start_date"
						name="start_date" /> <span class="input-group-addon">-</span> <input
						type="text" class="form-control" id="end_date" name="end_date" />
				</div>
			</div>
			<div class="form-group">
				<span id="error" style="color: red; display: none;"
					class="float-right">Invalid user credentials</span> <input
					type="submit" class="btn btn-info btn-block mt-4"
					name="btnSubmitNotice" id="btnSubmitNotice" value="Submit" />
			</div>
		</form>
	</div>
	<% 
