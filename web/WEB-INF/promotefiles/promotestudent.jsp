        ...
        <div class="table-responsive">
            <table class="table table-condensed table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="button" id="btnCheckUncheck" value="Select All" class="btn btn-primary" onclick="checkAll();"/>
                            <input type="button" id="btnPromoteStudents" value="Promote to next Semester" class="btn btn-danger" onclick="promoteToNextSemester();"/>
                    </tr>
                </tbody>
            </table>
        </div> 
